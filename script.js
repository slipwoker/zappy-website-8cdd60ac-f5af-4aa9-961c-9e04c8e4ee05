    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "ורד סולמי-הירשפלד משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var response = await fetch(apiBase + '/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '8cdd60ac-f5af-4aa9-961c-9e04c8e4ee05',
                    name: data.name || '',
                    email: data.email || '',
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '8cdd60ac-f5af-4aa9-961c-9e04c8e4ee05';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '8cdd60ac-f5af-4aa9-961c-9e04c8e4ee05';
